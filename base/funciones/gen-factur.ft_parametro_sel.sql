...
#ISSUE				FECHA				AUTOR				DESCRIPCION
 #0				06-11-2025 20:26:28								Funcion que devuelve conjuntos de registros de las consultas relacionadas con la tabla 'factur.tparametro'	
 #
 ***************************************************************************/
	...
	if(p_transaccion='FACTUR_PARAME_SEL')then
    	...
    	begin
			...
			v_consulta:='select
						...
						parame.nro_tramite,
						parame.doc_iden,
						parame.id_usuario_ai,
						parame.fecha_reg,
						parame.usuario_ai,
						parame.id_usuario_reg,
						parame.id_usuario_mod,
						parame.fecha_mod,
